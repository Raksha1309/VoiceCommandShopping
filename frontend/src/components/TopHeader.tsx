    ...
    <header className="flex items-center justify-between p-6">
      <div className="flex-1 flex items-center gap-4 max-w-xl">
        ...
        <div className="relative flex-1">
          ...
          />
          <button className="absolute right-2 top-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-gradient-primary flex items-center justify-center text-white shadow-lg shadow-purple-500/20">
